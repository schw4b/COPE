...
# mean and SD
c(mean(d.base$BSSsum[is.assip]), sd(d.base$BSSsum[is.assip]))
c(mean(d.base$BSSsum[is.cg]), sd(d.base$BSSsum[is.cg]))
...
```{r}
# mean and SD
c(mean(d.base$COPE_mean[is.assip]), sd(d.base$COPE_mean[is.assip]))
c(mean(d.base$COPE_mean[is.cg]), sd(d.base$COPE_mean[is.cg]))
